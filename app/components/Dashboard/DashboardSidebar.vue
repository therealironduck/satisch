<template>
  <aside class="flex w-56 flex-col border-r border-neutral-800 bg-neutral-950 py-4">
    <nav class="flex flex-1 flex-col gap-1 px-2">
      ...
      <button
        class="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm text-neutral-300 hover:bg-neutral-800 hover:text-white"
      >
      ...
      <button
        ...
        disabled
      >
        <UIcon name="i-mdi-history" class="h-4 w-4 shrink-0" />
        <span class="flex-1 text-left">Recently opened</span>
      </button>
